    ...
    this.onChanged,
        ...
        assert(decoration is BoxTightDecoration ||
            (decoration is UnderlineDecoration &&
                pinLength - 1 == (decoration.gapSpaces?.length ?? (pinLength - 1))) ||
...
class _PinPaint extends CustomPainter {
  ...
  _drawBoxTight(Canvas canvas, Size size) {
    ...
    for (int i = 1; i < pinLength; i++) {
      ...
      canvas.drawLine(
          Offset(offsetX, dr.strokeWidth), Offset(offsetX, mainHeight - dr.strokeWidth), borderPaint);
    }
    ...
    text.runes.forEach((rune) {
      ...
      startX =
          dr.strokeWidth * (index + 1) + singleWidth * index + singleWidth / 2 - textPainter.width / 2;
